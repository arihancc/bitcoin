...
{
    const char* pszTimestamp = "The Times 27/05/17 UK home to 23,000 jihadists.";
    const CScript genesisOutputScript = CScript() << ParseHex("04678afdb0fe5548271967f1a67130b7104cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f") << OP_CHECKSIG;
...
public:
    CMainParams() {
       ...
       // consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1510704000; // November 15th, 2017.
        ...
        consensus.defaultAssumeValid = uint256S("0x0"); //453354
        ...
        genesis = CreateGenesisBlock(1495843201, 486436271, 0x1d00ffff, 1, 5 * COIN);
       ...
       vSeeds.push_back(CDNSSeedData("127.0.0.1", "127.0.0.1", true)); // Peter Todd, only supports x1, x5, x9, and xd
